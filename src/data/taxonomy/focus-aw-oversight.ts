...
export const focusAwOversightNodes: TaxonomyNode[] = [
  // ── NICHE: agent-hitl-review-confidence (Confidence-Gated Review) ──────────
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Per-Task Confidence Gate Configuration',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Multi-Signal Confidence Scoring Models',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Confidence Threshold Calibration Tools',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Confidence Score Drift Monitors',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Confidence-Based Review Priority Sorters',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Model vs. Data Uncertainty Decomposers',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Step-by-Step Confidence Gates for Long Tasks',
    description:
  ...
  // ── NICHE: agent-hitl-review-queue (Review Queue Systems) ──────────────────
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Expertise-Matched Workload Balancers',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'High-Throughput Batch Review Interfaces',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Messaging App Async Review Approval Flows',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Two-Tier Senior Reviewer Escalation',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Review Time Estimation and Deadline Trackers',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Reviewer Decision Consistency Auditors',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Review Interface Latency Optimizers',
    description:
  ...
  // ── NICHE: agent-hitl-feedback-annotation (Annotation Loops) ───────────────
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Preference-Labeled Response Pair Collectors',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Behavioral Principle Alignment Feedback Tools',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Annotator Disagreement Example Samplers',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Multi-Annotator Label Consensus Tools',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Domain Expert Annotation Recruitment Platforms',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Custom Annotation Interface Builders',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Automated Annotation Quality Checkers',
    description:
  ...
  // ── NICHE: agent-hitl-feedback-learning (Online Learning Integration) ───────
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Continuous Model Fine-Tuning Pipelines',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Continuous Reward Model Update Services',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Fast Feedback-to-Deployment Pipelines',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Input Distribution Shift Detectors',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Training Feedback Attribution Tools',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Shadow Mode Safety Testing Tools',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Per-User Response Personalization Tools',
    description:
  ...
  // ── NICHE: agent-hitl-audit-trail (Audit Trail Systems) ────────────────────
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Tamper-Evident Decision Record Stores',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Decision Replay and Simulation Environments',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'AI Transparency Compliance Report Generators',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Decision-to-Outcome Correlation Tools',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Role-Based Audit Log Access Controls',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Plain-Language Compliance Log Query Tools',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Decision Anomaly Detection Tools',
    description:
  ...
  // ── NICHE: aw-hg-ag-pause-resume (Pause-and-Resume Checkpoints) ─────────────
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Agent State Snapshot Frameworks',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Long-Running State Compression Tools',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Cross-Node Agent Resume Infrastructure',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Checkpoint Expiry and Notification Tools',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Partial-Approval Task Branching Tools',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Agent State Visualizers for Approvers',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Resume Duplicate-Action Prevention Tools',
    description:
  ...
  // ── NICHE: aw-hg-ag-high-stakes (High-Stakes Action Gating) ────────────────
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Action Reversibility Classifiers',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Dual-Control Multi-Human Approval Gates',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Business Justification Approval Gates',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Real-Time Spend Limit Enforcers',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Emergency Action Override Protocols',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Shadow-Mode Action Validity Testers',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Post-Action Mandatory Review Tools',
    description:
  ...
  // ── NICHE: aw-hg-rpe-guardrails (Inference-Time Guardrail Enforcement) ──────
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Policy Rule Enforcement Gateways',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Agent Action Intent Classifiers',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Low-Latency Request Guardrail Filters',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Multi-Layer Cascading Guardrail Pipelines',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Adaptive Behavior Anomaly Guardrails',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Cross-Agent Policy Sync Tools',
    description:
  ...
  // ── NICHE: aw-hg-rpe-budget-permissions (Budget & Permission Controls) ───────
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Token Budget Hard-Stop Enforcement',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Financial Transaction Spend Limit Guards',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Just-in-Time Minimal Permission Grant Tools',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Time-Limited Agent Permission Grants',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Hierarchical Agent Budget Delegation Tools',
    description:
  ...
  // ── NICHE: aw-hg-sg-data-residency (Data Residency Management) ──────────────
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Data Sensitivity Classification Tools',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Residency-Aware Inference Routing Tools',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Cross-Border Data Transfer Auditors',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Model Training Origin Trackers',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Government Cloud Deployment Connectors',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Regional Data Flow Monitoring Dashboards',
    description:
  ...
  // ── NICHE: aw-hg-sg-regulatory-compliance (Multi-Jurisdiction Compliance) ───
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'AI Regulation Conformity Assessment Tools',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Personal Data Rights Request Handlers',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Healthcare Compliance Governance Kits',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Cross-Jurisdiction Compliance Rule Arbitrators',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Regulatory Change Monitoring Tools',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Automated AI Risk Tier Classifiers',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Compliance Platform AI-Specific Connectors',
    description:
  ...
  // ── NICHE: aw-hg-gov-monitoring (Fleet Performance & Anomaly Monitoring) ─────
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Real-Time Agent Behavior Anomaly Detectors',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Multi-Agent Fleet Cost Dashboards',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Agent Response Latency Monitors',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Cross-Agent Dependency Maps',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Agent Fleet Health Score Calculators',
    description:
  ...
  // ── NICHE: aw-hg-gov-policy (Global Policy & Constraint Definition) ──────────
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Visual Policy Rule Canvas Designers',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Hierarchical Policy Inheritance Tools',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Policy Change Simulation Tools',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Policy Rule Conflict Detection Tools',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Policy Version Control and Change Audit Tools',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Plain-Language Policy Authoring Tools',
    description:
  ...
  // ── NICHE: aw-hg-gov-audit (Audit & Evidence Correlation) ───────────────────
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Audit-Ready Decision Trace Exporters',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Guardrail Compliance Verification Tools',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Risk Register Evidence Linking Tools',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Insurance Claim Evidence Package Builders',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Regulatory Examination Report Generators',
    description:
  ...
  },
  {
    ...
    depth: 4,
    depthLabel: 'focus',
    name: 'Continuous Guardrail Effectiveness Monitors',
    description:
